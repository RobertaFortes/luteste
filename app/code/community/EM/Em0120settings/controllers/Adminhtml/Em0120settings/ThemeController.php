<?php
class EM_Em0120settings_Adminhtml_Em0120settings_ThemeController extends Mage_Adminhtml_Controller_Action
{
	protected $_prefixBlock = 'em0120_';
	protected $_prefixPage = 'em0120_';
	protected $_packageTheme = 'default/em0120';
