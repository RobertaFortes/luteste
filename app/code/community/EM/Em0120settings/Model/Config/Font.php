<?php 
class EM_Em0120settings_Model_Config_Font
{
	const CACHE_KEY = 'EM0120SETTINGS_GOOGLE_FONTS';
	const CACHE_LIFETIME = 86400;
	
	protected $googlefonts_url = 'https://www.googleapis.com/webfonts/v1/webfonts?sort=popularity&key=AIzaSyCJjXh-BzmntPlpyM2hhQqbHXiyH3sEUos';
